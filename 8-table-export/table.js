...
(async () => {
  let table_exp_object = await WebAssembly.instantiate(
    new Uint8Array(export_bytes),
    importObject
  );

  importObject.js.tbl = table_exp_object.instance.exports?.tbl;

  importObject.js.wasm_increment = table_exp_object.instance.exports?.increment;
  importObject.js.wasm_decrement = table_exp_object.instance.exports?.decrement;
